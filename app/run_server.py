...
# modelpath = "/home/oleg/PycharmProjects/Project_ML_in_Busness/models/randomforest_pipeline.dill"
...
def predict():
	...
	if flask.request.method == "POST":
		...
		logger.info(f'{dt} Data: humidity={humidity}, sunshine={sunshine}, pressure={pressure}')
		try:
			preds = model.predict_proba(pd.DataFrame({"humidity": [humidity],
												  "sunshine": [sunshine],
												  "pressure": [pressure]}))
